<div class="">
    ...
    <div class="p-1 mx-2">
        <h1 class="text-2xl font-semibold text-gray-900">Presupuesto {{ $entidad->id? 'de '. $entidad->entidad  :'' }} </h1>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr wire:loading.class.delay="opacity-50" wire:key="fila-{{ $presupuesto->id }}">
                                ...
                                <td class="text-right">
                                    @if($presupuesto->presupuesto)
                                        <input type="text" value="{{ $presupuesto->presupuesto }}" class="w-full text-xs font-thin text-gray-500 truncate border-0 rounded-md"  readonly/>
                                    @endif
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="text" value="{{ $presupuesto->descripcion }}" class="w-full text-xs font-thin text-gray-500 truncate border-0 rounded-md"  readonly/>
                                </td>
                                <td class="text-right">
                    ...
                    <tfoot class="font-bold divide-y divide-gray-200">
                        <tr>
                            ...
                            <td class="w-24 pt-2 pr-4 text-sm text-right text-gray-600">{{ number_format(round($totalcoste,2),2) }}</td>
                            <td ></td>
                            <td class="w-24 pt-2 pr-4 text-sm text-right text-gray-600">{{ number_format(round($totalventa,2),2) }}</td>
                            <td ></td>
                            <td ></td>
                            <td colspan="2"></td>
                        </tr>
