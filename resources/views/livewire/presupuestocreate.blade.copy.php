<div class="fixed inset-0 z-10 overflow-y-auto ease-out duration-400">
    ...
    <!-- component -->
    <div class="flex items-center justify-center h-screen antialiased transition-opacity">
        <div class="flex flex-col w-11/12 mx-auto border border-gray-300 rounded-lg shadow-xl sm:w-5/6 md:w-8/12 lg:w-10/12">
            <div
            ...
            <div class="flex flex-col px-6 py-5 bg-gray-50">
                ...
                <textarea type="text" name="" placeholder="Type message..."
                    class="p-5 mb-5 bg-white border border-gray-200 rounded shadow-sm h-36" id=""></textarea>
                <div class="flex flex-col items-center mb-5 sm:flex-row sm:space-x-5">
                    <div class="w-full sm:w-1/2">
                        <p class="mb-2 font-semibold text-gray-700">Customer Response</p>
                        <select type="text" name=""
                            class="w-full p-5 bg-white border border-gray-200 rounded shadow-sm appearance-none" id="">
                            <option value="0">Add service</option>
                        </select>
                    </div>
                    <div class="w-full mt-2 sm:w-1/2 sm:mt-0">
            ...
            <div
                ...
                <button class="px-4 py-2 font-semibold text-white bg-blue-500 rounded">
                    Save
                </button>
            </div>
        </div>
